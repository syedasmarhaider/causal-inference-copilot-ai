...
PROJECT_BY_ENV_KEY="REGISTRY_PROJECT_${DEPLOY_ENV_UPPER}"
PROJECT_FROM_CONFIG="${!PROJECT_BY_ENV_KEY:-}"
...
REGISTRY_PROJECT_RESOLVED="${GH_REGISTRY_PROJECT:-${PROJECT_FROM_CONFIG:-${REGISTRY_PROJECT:-}}}"
