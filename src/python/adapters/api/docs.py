...
API_DESCRIPTION = (
    ...
    "- JWT-like tokens must include an `id`, `ID`, `uuid`, `user_id`, `uid`, or `sub` UUID claim in the payload.\n"
    "- Raw UUID and opaque bearer tokens are also accepted for local clients.\n"
    "- `/healthz` is public.\n"
