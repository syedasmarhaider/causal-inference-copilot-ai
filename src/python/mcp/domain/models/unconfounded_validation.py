...
class ValidationReport:
    ...
    potential_trim_fraction: float | None = (
        None  # hypothetical: how much would be trimmed at [lo,hi]
    )
    ...
    def summarize(self) -> dict[str, Any]:
        ...
        return {
            ...
            "n_problem_features": sum(1 for _, m in self.missingness_by_feature.items() if m > 0),
