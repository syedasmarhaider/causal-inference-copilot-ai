...
from python.domain.models.models import ChatMessage, WorkingDatasetInfo
...
class _StubDataflowApp:
    def __init__(self) -> None:
        ...
        self.latest_info_calls: list[tuple[UUID, UUID]] = []
        self.artifact_calls: list[dict[str, object]] = []
        self.upload_result = uuid4()
        self.latest_info_result: WorkingDatasetInfo | None = None
    ...
    def get_current_working_dataset_info(
        ...
        *,
        ...
        self.latest_info_calls.append((user_id, conversation_id))
        return self.latest_info_result
