...
class _ModelNuisance(ModelSelector):
    ...
    """
    def __init__(self, model_y: ModelSelector, model_t: ModelSelector) -> None:
        ...
    
    def train(self, is_selecting, folds, Y, T, X=..., W=..., Z=..., sample_weight=..., groups=...): # -> Self:
        ...
    
    def score(self, Y, T, X=..., W=..., Z=..., sample_weight=..., groups=..., y_scoring=..., t_scoring=..., t_score_by_dim=...): # -> tuple[Any, Any]:
        ...
    
    def predict(self, Y, T, X=..., W=..., Z=..., sample_weight=..., groups=...): # -> tuple[Any, Any]:
        ...
...
class _ModelFinal:
    ...
    """
    def __init__(self, model_final) -> None:
        ...
    
    def fit(self, Y, T, X=..., W=..., Z=..., nuisances=..., sample_weight=..., freq_weight=..., sample_var=..., groups=...): # -> Self:
        ...
    
    def predict(self, X=...):
        ...
    
    def score(self, Y, T, X=..., W=..., Z=..., nuisances=..., sample_weight=..., groups=..., scoring=...): # -> Any:
        """
    ...
    @staticmethod
    def wrap_scoring(scoring, Y_true, Y_pred, sample_weight=..., score_by_dim=...): # -> Any:
        """
...
class _RLearner(_OrthoLearner):
    ...
    """
    def __init__(self, *, discrete_outcome, discrete_treatment, treatment_featurizer, categories, cv, random_state, mc_iters=..., mc_agg=..., allow_missing=..., use_ray=..., ray_remote_func_options=...) -> None:
        ...
    ...
    def score(self, Y, T, X=..., W=..., sample_weight=..., scoring=...): # -> Any:
        """
    ...
    @property
    def nuisance_scores_y(self): # -> list[Any]:
        ...
    
    @property
    def nuisance_scores_t(self): # -> list[Any]:
        ...
    
    @property
    def residuals_(self): # -> tuple[Any, Any, Any, Any]:
        """
        Get the residuals.
    ...
    def score_nuisances(self, Y, T, X=..., W=..., Z=..., sample_weight=..., y_scoring=..., t_scoring=..., t_score_by_dim=...): # -> dict[str, list[Any]]:
        """
