...
class MultiOutputGRF(BaseEstimator):
    ...
    def fit(self, X, T, y, *, sample_weight=..., **kwargs): # -> Self:
        ...
    
    def predict(self, X, interval=..., alpha=...): # -> tuple[NDArray[Any], NDArray[Any], NDArray[Any]] | NDArray[Any]:
        ...
    
    def predict_and_var(self, X): # -> tuple[NDArray[Any], NDArray[Any]]:
        ...
    
    def predict_projection_and_var(self, X, projector): # -> tuple[NDArray[Any], NDArray[Any]]:
        ...
    
    def oob_predict(self, Xtrain): # -> NDArray[Any]:
        ...
    
    def feature_importances(self, max_depth=..., depth_decay_exponent=...): # -> NDArray[Any]:
        ...
    ...
    def __iter__(self): # -> zip[tuple[Any, ...]]:
...
class CausalForest(BaseGRF):
    ...
    def fit(self, X, T, y, *, sample_weight=...):
        """
...
class CausalIVForest(BaseGRF):
    ...
    def fit(self, X, T, y, *, Z, sample_weight=...):
        """
...
class RegressionForest(BaseGRF):
    ...
    """
    def __init__(self, n_estimators=..., *, max_depth=..., min_samples_split=..., min_samples_leaf=..., min_weight_fraction_leaf=..., max_features=..., min_impurity_decrease=..., max_samples=..., min_balancedness_tol=..., honest=..., inference=..., subforest_size=..., n_jobs=..., random_state=..., verbose=..., warm_start=...) -> None:
        ...
